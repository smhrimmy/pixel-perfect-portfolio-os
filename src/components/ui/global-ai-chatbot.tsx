    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed mb-[110px] md:mb-6 right-6 bottom-0 z-[9999] grid h-14 w-14 place-items-center rounded-full bg-primary text-primary-foreground shadow-lg hover:scale-105 transition-transform animate-in zoom-in duration-300"
        >
      ...
      {isOpen && (
        <div
          className="fixed mb-[110px] md:mb-6 right-6 bottom-0 z-[10000] flex flex-col w-[300px] max-w-[calc(100vw-3rem)] overflow-hidden rounded-2xl border border-border bg-card shadow-2xl animate-in slide-in-from-bottom-8 fade-in duration-300"
        >
