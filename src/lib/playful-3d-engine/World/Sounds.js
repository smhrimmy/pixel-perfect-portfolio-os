...
export default class Sounds
{
    ...
    setSettings()
    {
        this.settings = [
            {
                name: 'reveal',
                sounds: ['/playful-3d/sounds/reveal/reveal-1.mp3'],
                minDelta: 100,
                velocityMin: 0,
            ...
            {
                name: 'brick',
                sounds: ['/playful-3d/sounds/bricks/brick-1.mp3', '/playful-3d/sounds/bricks/brick-2.mp3', '/playful-3d/sounds/bricks/brick-4.mp3', '/playful-3d/sounds/bricks/brick-6.mp3', '/playful-3d/sounds/bricks/brick-7.mp3', '/playful-3d/sounds/bricks/brick-8.mp3'],
                minDelta: 100,
                velocityMin: 1,
            ...
            {
                name: 'bowlingPin',
                sounds: ['/playful-3d/sounds/bowling/pin-1.mp3'],
                minDelta: 0,
                velocityMin: 1,
            ...
            {
                name: 'bowlingBall',
                sounds: ['/playful-3d/sounds/bowling/pin-1.mp3', '/playful-3d/sounds/bowling/pin-1.mp3', '/playful-3d/sounds/bowling/pin-1.mp3'],
                minDelta: 0,
                velocityMin: 1,
                velocityMultiplier: 0.5,
                volumeMin: 0.35,
            ...
            {
                name: 'carHit',
                sounds: ['/playful-3d/sounds/car-hits/car-hit-1.mp3', '/playful-3d/sounds/car-hits/car-hit-3.mp3', '/playful-3d/sounds/car-hits/car-hit-4.mp3', '/playful-3d/sounds/car-hits/car-hit-5.mp3'],
                minDelta: 100,
                velocityMin: 2,
                velocityMultiplier: 1,
                volumeMin: 0.2,
            ...
            {
                name: 'woodHit',
                sounds: ['/playful-3d/sounds/wood-hits/wood-hit-1.mp3'],
                minDelta: 30,
                velocityMin: 1,
                velocityMultiplier: 1,
                volumeMin: 0.5,
            ...
            {
                name: 'screech',
                sounds: ['/playful-3d/sounds/screeches/screech-1.mp3'],
                minDelta: 1000,
                velocityMin: 0,
                velocityMultiplier: 1,
                volumeMin: 0.75,
            ...
            {
                name: 'uiArea',
                sounds: ['/playful-3d/sounds/ui/area-1.mp3'],
                minDelta: 100,
                velocityMin: 0,
                velocityMultiplier: 1,
                volumeMin: 0.75,
            ...
            {
                name: 'carHorn1',
                sounds: ['/playful-3d/sounds/car-horns/car-horn-1.mp3'],
                minDelta: 0,
                velocityMin: 0,
                velocityMultiplier: 1,
                volumeMin: 0.95,
            ...
            {
                name: 'carHorn2',
                sounds: ['/playful-3d/sounds/car-horns/car-horn-2.mp3'],
                minDelta: 0,
                velocityMin: 0,
                velocityMultiplier: 1,
                volumeMin: 0.95,
            ...
            {
                name: 'horn',
                sounds: ['/playful-3d/sounds/horns/horn-1.mp3', '/playful-3d/sounds/horns/horn-2.mp3', '/playful-3d/sounds/horns/horn-3.mp3'],
                minDelta: 100,
                velocityMin: 1,
                velocityMultiplier: 0.75,
                volumeMin: 0.5,
    ...
    setEngine()
    {
        ...
        this.engine.sound = new Howl({
            src: ['/playful-3d/sounds/engines/1/low_off.mp3'],
            loop: true
        })
        ...
        this.time.on('tick', () =>
        {
            ...
            // Rate & Volume only if loaded to prevent stack overflow
