...
//             'color: #705df2;'
//         )
        console.log('%cInspired by the 🔥 https://bruno-simon.com/ - website', 'color: #32ffce');
        console.log('%c🎁 https://github.com/brunosimon/folio-2019 - developer code', 'color: #32ffce');
    }
